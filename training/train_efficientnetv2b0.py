...
# PHASE 2 - FINE TUNE
# ======================
print("\nPHASE 2: Fine-tuning EfficientNetV2B0")
...
print("EfficientNetV2B0 test accuracy:", test_acc)

# ======================
# SAVE
# ======================
Path("models").mkdir(exist_ok=True)
model.save("models/efficientnetv2b0_transfer.keras")
print("Model saved to models/efficientnetv2b0_transfer.keras")
